...
class Session(models.Model):
	...
	#Alert Data
	Alert_No_IV = models.CharField(max_length=20) #No IVlocalStorage.setItem("Alert No IV", "not thrown");
	Alert_One_PIV = models.CharField(max_length=20) #localStorage.setItem("Alert One PIV", "not thrown");

	Functional_Peripheral_IV_established = models.BooleanField() #localStorage.setItem("Functional Peripheral IV established", "false");
	Alert_No_IV = models.CharField(max_length=20)# localStorage.setItem("Functional Peripheral IV count", "0");

	Alert_No_IV = models.BooleanField()# localStorage.setItem("Intraosseous Line established", "false");
	Alert_No_IV = models.BooleanField()# localStorage.setItem("Central Line established", "false");
